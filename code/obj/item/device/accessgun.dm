/obj/item/device/accessgun
	name = "access-pro"
	desc = "This device can reprogram electronic access requirements. It will copy the permissions of any inserted ID."
	...
	req_access = list(list(access_change_ids,access_engineering_chief))
	...
	proc/reprogram(var/obj/O,var/mob/user)
		...
		playsound(get_turf(src), "sound/machines/reprog.ogg", 50, 1)
